...
class TestMEBinPostProcessor:
    ...
    def test_forward_single_anomaly_map(mock_mebin) -> None:
    ...
    @staticmethod
    @patch('anomalib.post_processing.mebin_post_processor.MEBin')
    def test_forward_batch_anomaly_maps(mock_mebin) -> None:
    ...
    @staticmethod
    @patch('anomalib.post_processing.mebin_post_processor.MEBin')
    def test_forward_normalization(mock_mebin) -> None:
    ...
    @staticmethod
    @patch('anomalib.post_processing.mebin_post_processor.MEBin')
    def test_forward_mebin_parameters(mock_mebin) -> None:
    ...
    @staticmethod
    @patch('anomalib.post_processing.mebin_post_processor.MEBin')
    def test_forward_binary_mask_conversion(mock_mebin) -> None:
